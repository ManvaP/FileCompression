...
<body>
	<%
			...
			String newAirline = request.getParameter("newAirline");
		try {
			ApplicationDB db = new ApplicationDB();	
			Connection con = db.getConnection();
			Statement stmt = con.createStatement();
			String str = "Update `Aircraft` set airlineID = '" + newAirline + "' where aircraftID = " + aircraft; 			
...
<br>
	...
	<input type="hidden" name="aircraft" value=  <%out.print(aircraft); %>>
