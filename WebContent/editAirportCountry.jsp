...
<title>Editing Airport Country Page</title>
</head>
<body>
	<%
		String airport = request.getParameter("airport");
		String newAirport = request.getParameter("newCountry");
		try {
			ApplicationDB db = new ApplicationDB();	
			Connection con = db.getConnection();
			Statement stmt = con.createStatement();
			String str = "Update `Airport` set country = '" + newAirport + "' where airportID = '" + airport + "'"; 			
...
<br>
	...
	<input type="hidden" name="airport" value=  <%out.print(airport); %>>
