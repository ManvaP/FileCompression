...
<title>Editing Airport City Page</title>
</head>
<body>
	<%
		String airport = request.getParameter("airport");
		String newAirport = request.getParameter("newCity");
		try {
			ApplicationDB db = new ApplicationDB();	
			Connection con = db.getConnection();
			Statement stmt = con.createStatement();
			String str = "Update `Airport` set city = '" + newAirport + "' where airportID = '" + airport + "'"; 			
